...
class LocalesFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    private var localesMutableList: MutableList<Local> = arrayListOf()
    ...
    override fun onCreateView(
        ...
        val CLocales = ControladorLocal(contexto!!)
        localesMutableList = CLocales.buscarLocales().toMutableList()
